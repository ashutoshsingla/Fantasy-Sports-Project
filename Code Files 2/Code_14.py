...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 10 19:38:24 2022
...
for x in range(0,31):
    ...
    for i in range(0,len(real_score)):
        ...
        if a>b:
            ...
            tie += 1
    dict_win_real[name] = [win_real/len(real_score), win_real/win_sim, sum(diff_score)/len(diff_score),statistics.pstdev(diff_score)]
...
new.to_csv("/Users/ashutoshsingla/Desktop/Fantasy_Project/simulationtype2all.csv")