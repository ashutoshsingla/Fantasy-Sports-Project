...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  2 20:49:28 2022
...
for x in range(0, 1):
    ...
    df = pd.read_csv('/Users/ashutoshsingla/Desktop/Fantasy_Project/conv3/'+name+'.csv')
    ...
    sim_teams.to_csv('/Users/ashutoshsingla/Desktop/Fantasy_Project/simulated_teams/'+name+'.csv')